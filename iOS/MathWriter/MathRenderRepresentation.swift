...
"""
    ...
    public func html(colorMode: Int = 0, scaleMode: Double = 1) -> String {
        var h = script1 + script2 + "<h1>$\(_latexConversion)$</h1>" + js.replacingOccurrences(of: "FONT_SCALE", with: "\(100*scaleMode)px")
